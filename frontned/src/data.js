...
export const teamData = {
  ...
  "Advisors": [
    { name: "Prof. S. M. Narulkar", role: "Advisor", avatar: "/NalurkarSir.jpg" },
    { name: "Prof. D. A. Mehta", role: "Advisor", avatar: "/DAmetha.jpg" },
    { name: "Prof. H. K. Mahiyar", role: "Advisor", avatar: "Prof H. K Mayiar.jpg" },
    { name: "Prof. Rakesh Khare", role: "Advisor", avatar: "Prof. Rakesh Khare.jpg" },
    { name: "Prof. P.P. Bansod", role: "Advisor", avatar: "Prof. P.P. Bansod.jpg" },
    { name: "Prof. M. L. Jain", role: "Advisor", avatar: "Prof. M. L. Jain.jpg" },
    { name: "Prof. H. K. Verma", role: "Advisor", avatar: "Prof. H. K. Verma.jpg" },
    { name: "Prof. Urjita Takkar", role: "Advisor", avatar: "Prof. Urjita Takkar.jpg" },
    // { name: "All HODS", role: "Advisors", avatar: "https://i.pravatar.cc/150?u=ad9" },
  ],
  "Prarupam Team": [
    { name: "Prof. Vinod Pare", role: "Team Lead", avatar: "Prof Vinod Pare.jpg" },
    ...
    { name: "Prof. Manjeet Soni", role: "Member", avatar: "Prof. Manjeet Soni.jpg" },
    ...
    { name: "Prof. Gangaram Mourya", role: "Member", avatar: "gangaram mourya.jpg" },
  ...
  "Expo Team": [
    ...
    { name: "Prof. Anujulata Yadav", role: "Co-Team Lead", avatar: "Prof. Anujulata Yadav.jpg" },
    ...
    { name: "Prof. Swati Chougaonkar", role: "Co-Team Lead", avatar: "swati_chaugaonakar-mam.webp" },
    ...
    { name: "Prof. Anil Mulewa", role: "Member", avatar: "Prof_A_Mulewa.webp" },
  ...
  "Website Management Team": [
    { name: "Prof. Megha Kuliha", role: "Team Lead", avatar: "megha_kuliha_mam.webp" },
  ...
  "IT-CELL Team": [
    { name: "Prof. Manish Panchal", role: "Team Lead", avatar: "" },
    { name: "Prof. Chandra Prakash Singar", role: "Co-Team Lead", avatar: "CPSingh_sir.png" },
    { name: "Prof. Jyoti Gautam Tiwari", role: "Member", avatar: "jyoti_tiwari_mam.png" },
    { name: "Prof. Upendra Singh", role: "Member", avatar: "uprendra_singh.webp" },
  ],
  "Finance Team": [
    { name: "Prof. Neeraj Jain", role: "Team Lead", avatar: "" },
    { name: "Prof. Vibha Bhatnagar", role: "Co-Team Lead", avatar: "" },
    { name: "Prof. Gauri Gupta", role: "Member", avatar: "" },
    { name: "Prof. Ashish Mahajan", role: "Member", avatar: "" },
    { name: "Prof. Neha Mehra", role: "Member", avatar: "neha_mehra.png" },
  ],
};
